...
public class CalculaPricePage extends BasicWrap{
	...
	String antiquity = "10";//Ingrese la antiguedad del inmueble en a�os
	...
	int toiletsLess = 0;//Ingrese el numero de clicks si desea disminuir la cantidad de ba�os
	int toiletsMore = 0; //Ingrese el numero de clicks si desea aumentar la cantidad de ba�os 
