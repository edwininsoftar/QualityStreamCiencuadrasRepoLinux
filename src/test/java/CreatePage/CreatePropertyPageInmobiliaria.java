...
public class CreatePropertyPageInmobiliaria extends BasicWrap{
	...
	//Caracteristicas informaci�n basica
	...
	String bath = "2";//Ingrese e numero de ba�os
	...
	String additionalInformation = "amoblado colores frescos";//Ingrese formaci�n adicional
