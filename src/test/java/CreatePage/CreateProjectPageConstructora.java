...
public class CreateProjectPageConstructora extends BasicWrap{
	...
	String valueManagement = "100000";//Ingrese el precio de la administraci�n 
	String tvCircuit = "No";//ingrese Si o No si cuenta con circuito cerrado de tv
	String ServiceRoom = "No";//Ingrese Si o No si cuenta con habitaci�n de servicio
	String serviceBath = "No";//Ingrese Si o No si cuenta con ba�o de servicio
	...
	String additionalInformation = "Buena ubicaci�n";//Informacion adicional
	...
	public void validation() {
		try {
			...
			if(numberRoom.equals(sEndRoom)) {
				...
				System.out.println("El n�mero de habitaciones consultadas no concuerda con los ingresadas");
			}
